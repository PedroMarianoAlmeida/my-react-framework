...
// src/controlled-structure/client-side-slots/client-fetch-data.jsx
...
var GithubReposClientWay = ({ username = "PedroMarianoAlmeida" }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("session", { children: [
...
var rootElement = document.getElementById("client-fetch-data");
(0, import_client.createRoot)(rootElement).render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(GithubReposClientWay, {}));
